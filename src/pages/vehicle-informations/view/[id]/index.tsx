...
import { getVehicleInformationById } from 'apiSdk/vehicle-informations';
import { VehicleInformationInterface } from 'interfaces/vehicle-information';

function VehicleInformationViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Vehicle Information Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('vehicle_information', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/vehicle-informations/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Maintenance History" text={data?.maintenance_history} />

                <FormListItem label="Vehicle Color" text={data?.vehicle_color} />
